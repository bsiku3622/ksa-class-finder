...
const SearchResultDisplay: React.FC<SearchResultDisplayProps> = ({
                ...
                {parts.map((part, i) => {
                    ...
                    if (isOperator) {
                        return (
                            <span
                                key={i}
                                className="text-retro-primary font-black px-0.5"
                            >
                                {part}
                            </span>
                        );
    ...
    const matchSummary = useMemo(() => {
        ...
        if (counts.room > 0)
            parts.push(`${counts.room} Room${counts.room > 1 ? "s" : ""}`);
                            ...
                            <div className="pt-8 border-t-2 border-black/10 flex-1 flex flex-col gap-10">
                                <div className="grid grid-cols-2 gap-4">
                                    <RetroStatItem
                                        ...
                                        value={searchResult.total_subjects}
                                        unit="Items"
                                        size="sm"
                                    />
                                    <RetroStatItem
                                        label="Total Sections"
                                        value={searchResult.total_sections}
                                        unit="Classes"
                                        size="sm"
                                    />
                                </div>
                                            ...
                                            {primaryEntity.subjects.map(
                                                (sub, i) => (
                                                    <button
                                                        ...
                                                        style={{
                                                            borderLeftColor: `${getEntityColor(primaryEntity)}40`,
                                                        }}
                                                    >
                                                        {sub}
                                                    </button>
