...
1~4교시(08:40~12:30) → 점심(~13:10)·학급모임(13:20~13:30) → 5~9교시(13:40~18:30) →
**한 시간 건너뛰고** 10~11교시(19:30~21:20).

⚠️ **점심 구멍은 이름으로 꽉 차 있지 않습니다.** 12:30~13:40 의 70분 중 13:10~13:20
(퇴실)과 13:30~13:40(5교시로 이동)은 `BREAKS` 어디에도 없습니다 — 화면이 그 자리를
공강으로 읽지 않게 하는 건 프론트(`lib/homeView.ts`)의 몫입니다.
